...
ntn mcp e <page-id> --replace-range "partial"        # Replace range
ntn mcp e <page-id> --insert-after "appended text"   # Insert after
ntn mcp e <page-id> --new "new section"              # Add new section
